...
> Sec 1 (the authority derivation and the register tails); Sec 2 (the locked
> sequence's order unasserted; zero repository presence); Sec 3.3 (v2.68's
> dependency SHA); Sec 4.4; Sec 6 item 2.
