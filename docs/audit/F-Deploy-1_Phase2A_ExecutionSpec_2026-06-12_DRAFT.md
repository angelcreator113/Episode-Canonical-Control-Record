> **CORRECTION 2026-06-18 (additive-supersede):** The line-1 "[RESOLVED — P-4/P-5
> CLOSED (PASS)]" banner is **superseded**. P-4/P-5 is **NOT PASSED** — see the
> canonical correction in `F-Deploy-1_P4P5_PASS_2026-06-18.md` (2026-06-18). The
> Sec 0 / Sec 1 "OPEN" markers for P-4/P-5 are **current**, not at-filing history.
> [3] precondition UNMET; box FROZEN; [3] not primed.
