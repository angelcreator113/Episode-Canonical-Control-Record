/**
 * WorldDashboard — Track 6 CP7 behavioral tests (file 10 of 10).
 *
 * 8 fetch sites migrated via 7 module-scope helpers + 1 internal safeFetch
 * refactor. The component-local safeFetch helper now wraps apiClient.get
 * (preserving the `safeFetch(url) → null on error` signature for the 8
 * callers in the setup-status useEffect).
 */
...
describe('WorldDashboard — Track 6 CP7 module-scope helpers', () => {
  beforeEach(() => {
