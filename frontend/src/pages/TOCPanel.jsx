      ...
      {chapters.length === 0 ? (
        ...
        <div style={s.chapterList}>
            ...
            return (
              ...
              >
                ...
                <div style={s.chInfo}>
                  <div style={{
                    ...s.chTitle,
                    color: complete ? 'rgba(245,240,232,0.9)' : 'rgba(245,240,232,0.72)',
                  }}>
                    {chapter.title}
                  </div>
                  ...
                  <div style={s.chCounts}>
                    ...
                    <span style={{ color: 'rgba(245,240,232,0.2)', marginLeft: 'auto' }}>
                      {lines.length} lines
                    </span>
                  </div>
                </div>
          ...
          <div style={{ ...s.chapterRow, opacity: 0.3, cursor: 'default', pointerEvents: 'none' }}>
            ...
            <div style={s.chInfo}>
              <div style={{ ...s.chTitle, fontStyle: 'italic', color: 'rgba(245,240,232,0.3)' }}>
                [ Not yet compiled ]
              </div>
