...
module.exports = (sequelize) => {
  const Scene = sequelize.define(
    'Scene',
    {
      ...
      scene_set_id: {
        ...
        allowNull: true,
        field: 'scene_set_id',
        comment: 'FK to scene_sets — the canonical location this scene uses',
      },
      scene_angle_id: {
        type: DataTypes.UUID,
        allowNull: true,
  ...
  Scene.prototype.toJSON = function () {
    return {
      ...
      sceneSetId: this.scene_set_id,
      sceneAngleId: this.scene_angle_id,
      sceneSet: this.sceneSet || undefined,
      sceneAngle: this.sceneAngle || undefined,
