...
module.exports = (sequelize) => {
  ...
  SceneAngle.init({
    ...
    artifact_flags: { type: DataTypes.JSONB, allowNull: true, defaultValue: [] },
    quality_review: { type: DataTypes.JSONB, allowNull: true, defaultValue: null },
    generation_attempt: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 1 },
    refined_prompt: { type: DataTypes.TEXT, allowNull: true },
    camera_motion: { type: DataTypes.STRING, allowNull: true },
    video_duration: { type: DataTypes.INTEGER, allowNull: true, defaultValue: 5 },
    ...
    variation_data: { type: DataTypes.JSONB, allowNull: true, defaultValue: null },
