...
module.exports = (sequelize, DataTypes) => {
  class CharacterFollowProfile extends Model {
    static associate(models) {
      if (models.RegistryCharacter) {
        CharacterFollowProfile.belongsTo(models.RegistryCharacter, {
  ...
  CharacterFollowProfile.init({
    ...
    sequelize,
    modelName:  'CharacterFollowProfile',
