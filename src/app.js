          ...
          try {
            ...
            const migrationTables = {
              world_events: `CREATE TABLE IF NOT EXISTS world_events (
                ...
                show_id UUID NOT NULL, season_id UUID, arc_id UUID,
                name VARCHAR(200) NOT NULL,
                event_type VARCHAR(30) DEFAULT 'invite',
                ...
                dress_code VARCHAR(200), dress_code_keywords JSONB DEFAULT '[]',
                location_hint TEXT, narrative_stakes TEXT,
                canon_consequences JSONB DEFAULT '{}',
                seeds_future_events JSONB DEFAULT '[]',
                status VARCHAR(20) DEFAULT 'ready',
                used_in_episode_id UUID, host VARCHAR(200),
                invitation_asset_id UUID, scene_set_id UUID,
