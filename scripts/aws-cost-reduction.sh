...
echo "   If you're already on t3.medium, consider:"
echo "     - EC2 Savings Plan (1yr, no upfront): ~$19/month (37% savings)"
echo "     - Reserved Instance (1yr, no upfront): ~$20/month (33% savings)"
echo ""
